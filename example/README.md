...
This example project let you download an arbitrary pdf file from the internet.
After downloading the pdf file will be instantly rendered.
When rendering a pdf document that has multiple pages, simply swipe right or left to navigate through the
pdf document.
